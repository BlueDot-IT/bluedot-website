...
export const projectCatalog: ProjectCatalogEntry[] = [
  ...
  {
    name: 'BlueDot IT website',
    url: 'https://github.com/BlueDot-IT/bluedot-website',
    ...
    featured: true,
    caseStudy: {
      problem: 'A consultancy site has to explain the work, publish useful writing, handle inquiries, protect its admin surface, and remain deployable as content changes.',
      work: 'This application combines public server-rendered routes, Prisma-backed Insights and administration, contact and newsletter flows, metadata, security controls, and VPS deployment.',
      evidence: 'The live site and public source repository are available for inspection, including routes, tests, deployment configuration, and content operations.',
      result: 'The website is a working service surface and an inspectable example of the full-stack concerns BlueDot brings to client systems.',
      artifact: '/proof/full-stack-delivery.svg',
      artifactAlt: 'Diagram showing a full-stack capability moving from interface and API design through data, tests, deployment, and handoff.',
      artifactCaption: 'Public artifact: the delivery path used by this site.',
    },
  },
  {
    name: 'Odinn-Forge',
