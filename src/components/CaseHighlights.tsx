    ...
    <section className="sr2-section" id="services">
      <div className="sr2-wrap">
        ...
        <div className="sr2-rail-list">
          <Link className="sr2-rail featured" href="/services/operations-automation-reporting">
          ...
          <Link className="sr2-rail" href="/services/security-reviews">
          ...
          <Link className="sr2-rail" href="/services/full-stack-development">
